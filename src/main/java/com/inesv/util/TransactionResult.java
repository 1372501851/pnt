...
public class TransactionResult {
	...
	public TransactionResult(String url, String port, String username, String password, String walletpaps) {
		...
		ba = new BitcoinAPI(url, port, username, password, walletpaps);
	...
	public boolean validateaddress(String address) {
		...
		logger.info(address);
		String returnAnswer = ba.validateaddress(address);
		try {
			Map<String, Object> map = JSON.parseObject(returnAnswer, Map.class);
			isValis = (boolean) map.get("isvalid");
	...
	public String sendToAddress(String address,BigDecimal amount){
		 return  ba.sendToAddress(address, amount);
	}
