...
public class zbApi {
	...
	private static Logger log = Logger.getLogger(zbApi.class);

	// 正式
	public final String ACCESS_KEY = "b6b72e9b-5856-4da0-a752-52696a74327b";
	public final String SECRET_KEY = "49bb1ae3-b584-4983-aba3-c6e89fc8fc9c";
...
//	@Test
	 ...
	 */
//	@Test
	public String testTicker(String coin) {
		String currency = "";
